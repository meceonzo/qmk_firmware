...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_LAYER0] = LAYOUT(
        ...
        KC_LSFT,   KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,      KC_N,      LT(2,KC_M),KC_COMM,   KC_DOT,    KC_SLSH,   KC_RSFT,              KC_UP,         KC_PGDN,
        KC_LCTL,   KC_LGUI,   KC_LALT,                              KC_SPC,                                KC_RALT,   MO(1),     KC_INS,    KC_LEFT,   KC_DOWN,   KC_RGHT
    ),
    ...
    [_MOVE_LAYER2] = LAYOUT(
        ...
        XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   _______,       XXXXXXX, 
        XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_UP,     XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   _______,       XXXXXXX, 
        XXXXXXX,   XXXXXXX,   KC_LEFT,   KC_DOWN,   KC_RGHT,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_HOME,   KC_END,    KC_PGUP,   XXXXXXX,              _______,       XXXXXXX, 
        _______,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_PGDN,   _______,              XXXXXXX,       XXXXXXX,   
